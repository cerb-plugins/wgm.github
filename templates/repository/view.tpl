	...
	<tbody style="cursor:pointer;">
		<tr class="{$tableRowClass}">
			...
			<td colspan="{$smarty.foreach.headers.total}">
				...
				<button type="button" class="peek" style="visibility:hidden;padding:1px;margin:0px 5px;" onclick="genericAjaxPopup('peek','c=internal&a=showEntryPopup&id={$result.g_id}&view_id={$view->id}',null,false,'500');"><span class="cerb-sprite2 sprite-document-search-result" style="margin-left:2px" title="{'views.peek'|devblocks_translate}"></span></button>
			</td>
		</tr>
